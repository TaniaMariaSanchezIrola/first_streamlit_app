...
fruitsSelected = streamlit.multiselect("Pick some fruits:", list(my_fruit_list.index))
fruits_to_show = my_fruit_list.loc[fruitsSelected]
...
add_fruit = streamlit.text_input('What kind of fruit would you like to add?','Apple')
